/**
 * 《詩經》全文資料（305 篇）
 * 原始資料：chinese-poetry/chinese-poetry，MIT License
 * https://github.com/chinese-poetry/chinese-poetry/tree/master/詩經
 * 繁體轉換：OpenCC s2twp；古籍文字仍應以權威紙本校勘本為準。
 *
 * 編輯方式：每篇為一筆物件，可直接修改 title / chapter / section / stanzas。
 */
export type Poem = {
  id: number;
  title: string;
  chapter: "國風" | "小雅" | "大雅" | "周頌" | "魯頌" | "商頌";
  section: string;
  stanzas: string[];
};
...
export const poems: Poem[] = [
  ...
  },
  {
    ...
    "section": "王風",
    "stanzas": [
      "中谷有蓷，暵其幹矣。有女仳離，慨其嘆矣。慨其嘆矣，遇人之艱難矣。",
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "灑掃穹窒，我徵聿至。有敦瓜苦，烝在栗薪。自我不見，於今三年。",
      "我徂東山，慆慆不歸。我來自東，零雨其濛。倉庚于飛，熠耀其羽。",
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "蠢爾蠻荊，大邦為仇。方叔元老，克壯其猶。方叔率止，執訊獲醜。戎車嘽嘽，",
      "嘽嘽焞焞，如霆如雷。顯允方叔，征伐玁狁，蠻荊來威。"
    ]
  },
  {
    "id": 179,
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "爾之安行，亦不遑舍。爾之亟行，遑脂爾車。一者之來，云何其盱。",
      "爾還而入，我心易也。還而不入，否難知也。一者之來，俾我絺也。",
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "曾孫來止，以其婦子。饁彼南畝，田畯至喜。攘其左右，",
      "嘗其旨否。禾易長畝，終善且有。曾孫不怒，農夫克敏。",
      "曾孫之稼，如茨如梁。曾孫之庾，如坻如京。乃求千斯倉，",
      "乃求萬斯箱。黍稷稻粱，農夫之慶。報以介福，萬壽無疆。"
    ]
  },
  {
    "id": 212,
    ...
    "stanzas": [
      ...
      "播厥百穀，既庭且碩，曾孫是若。",
      "既方既皂，既堅既好，不稂不莠。去其螟螣，及其蟊賊，",
      "無害我田稚。田祖有神，秉畀炎火。",
      "有渰萋萋，興雨祈祈。雨我公田，遂及我私。彼有不獲稚，",
      "此有不斂穧，彼有遺秉，此有滯穗，伊寡婦之利。",
      "曾孫來止，以其婦子。饁彼南畝，田畯至喜。來方禋祀，",
      "以其騂黑，與其黍稷。以享以祀，以介景福。"
    ]
  },
  {
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "殷商之旅，其會如林。矢於牧野，維予侯興。上帝臨女，無二爾心。",
      "牧野洋洋，檀車煌煌，駟騵彭彭。維師尚父，時維鷹揚。涼彼武王，四伐大商，會朝清明。"
    ]
  },
  {
    "id": 237,
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "雍雍在宮，肅肅在廟。不顯亦臨，無射亦保。",
      "四戎疾不殄，烈假不瑕。不聞亦式，不諫亦入。四成人有德，小子有造。古之人無斁，譽髦斯士。"
    ]
  },
  {
    "id": 241,
    ...
    "stanzas": [
      ...
      "作之屏之，其菑其翳。修之平之，其灌其栵。啟之闢之，其檉其椐。",
      "攘之剔之，其檿其柘。帝遷明德，串夷載路。天立厥配，受命既固。",
      "帝省其山，柞棫斯拔，松柏斯兌。帝作邦作對，自大伯王季。維此王季，",
      "因心則友。則友其兄，則篤其慶，載錫之光。受祿無喪，奄有四方。",
      "維此王季，帝度其心。貊其德音，其德克明。克明克類，克長克君。",
      "王此大邦，克順克比。比於文王，其德靡悔。既受帝祉，施於孫子。",
      "帝謂文王：無然畔援，無然歆羨，誕先登於岸。密人不恭，敢距大邦，",
      "侵阮徂共。王赫斯怒，爰整其旅，以按徂旅。以篤於周祜，以對於天下。",
      "依其在京，侵自阮疆。陟我高岡，無矢我陵。我陵我阿，無飲我泉，",
      "我泉我池。度其鮮原，居岐之陽，在渭之將。萬邦之方，下民之王。",
      "帝謂文王：予懷明德，不大聲以色，不長夏以革。不識不知，順帝之則。",
      "帝謂文王：訽爾仇方，同爾弟兄。以爾鉤援，與爾臨衝，以伐崇墉。",
      "臨衝閒閒，崇墉言言。執訊連連，攸馘安安。是類是禡，是致是附，",
      "四方以無侮。臨衝茀茀，崇墉仡仡。是伐是四，是絕是忽。四方以無拂。"
    ]
  },
  {
    "id": 242,
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "實發實秀，實堅實好。實穎實慄，即有邰家室。",
      "誕降嘉種，維秬維秠，維穈維芑。恆之秬秠，是獲是畝。",
      "恆之穈芑，是任是負。以歸肇祀。",
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "思輯用光，弓矢斯張；干戈戚揚，爰方啟行。",
      "篤公劉，於胥斯原。既庶既繁，既順乃宣，而無永嘆。陟則在巘，",
      "復降在原。何以舟之？維玉及瑤，鞞琫容刀。",
      "篤公劉，逝彼百泉。瞻彼溥原，乃陟南岡。乃覯於京，京師之野。",
      "於時處處，於時廬旅，於時言言，於時語語。",
      "篤公劉，於京斯依。蹌蹌濟濟，俾筵俾幾。既登乃依，乃造其曹。",
      "執豕於牢，酌之用匏。食之飲之，君之宗之。",
      "篤公劉，既溥既長。既景乃岡，相其陰陽，觀其流泉。其軍三單，",
      "度其隰原。徹田為糧，度其夕陽。豳居允荒。",
      "篤公劉，於豳斯館。涉渭為亂，取厲取鍛，止基乃理。爰眾爰有，",
      "夾其皇澗。溯其過澗。止旅乃密，芮鞫之即。"
    ]
  },
  {
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "申伯之德，柔惠且直。揉此萬邦，聞於四國。吉甫作誦，其詩孔碩。其風四好，以贈申伯。"
    ]
  },
  {
    "id": 260,
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "蟊賊蟊疾，靡有夷屆。罪罟不收，靡有夷瘳。",
      "人有土田，女反有之。人有民人，女覆奪之。此宜無罪，女反收之。",
      "彼宜有罪，女覆說之。",
      "哲夫成城，哲婦傾城。懿厥哲婦，為梟為鴟。婦有長舌，維厲之階。",
      "亂匪降自天，生自婦人。匪教匪誨，時維婦寺。",
      "鞫人忮忒。譖始競背。豈曰不極？伊胡為慝？如賈三倍，君子是識。",
      "婦無公事，休其蠶織。",
      "天何以剌？何神不富？舍爾介狄，維予胥忌。不弔不祥，威儀不類。",
      "人之雲亡，邦國殄瘁。",
      "天之降罔，維其優矣。人之雲亡，心之憂矣。天之降罔，維其幾矣。",
      "人之雲亡，心之悲矣。",
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "池之竭矣，不雲自頻。泉之竭矣，不雲自中。溥斯害矣，職兄斯弘，不災我躬。",
  ...
  },
  {
    ...
    "section": "清廟之什",
    "stanzas": [
      "昊天有成命，二後受之。成王不敢康，夙夜基命宥密。於緝熙！單厥心，四其靖之。"
    ]
  },
  {
    "id": 272,
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "明昭有周，式序在位。載戢干戈，載橐弓矢。我求懿德，四於時夏，允王保之。"
    ]
  },
  {
    "id": 274,
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "乃奏，簫管備舉。喤喤厥聲，肅雍和鳴，先祖是聽。我客戾止，永觀厥成。"
    ]
  },
  {
    "id": 281,
  ...
  },
  {
    ...
    "section": "臣工之什",
    "stanzas": [
      "有來雝雝，至止肅肅。相維闢公，天子穆穆。於薦廣牡，相予四祀。假哉皇考！綏予孝子。",
  ...
  },
  {
    ...
    "section": "臣工之什",
    "stanzas": [
      "載見闢王，曰求厥章。龍旂陽陽，和鈴央央。鞗革有鶬，休有烈光。率見昭考，以孝以享。",
      "以介眉壽，永言保之，思皇多祜。烈文闢公，綏以多福，俾緝熙於純嘏。"
    ]
  },
  {
    "id": 284,
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "有厭其傑，厭厭其苗，綿綿其麃。載獲濟濟，有實其積，萬億及秭。為酒為醴，烝畀祖妣，不洽百禮。",
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "其笠伊糾，其鎛斯趙，以薅荼蓼。荼蓼朽止，黍稷茂止。獲之挃挃，積之慄慄。",
      "其崇如墉，其比如櫛。以開百室，百室盈止，婦子寧止。殺時犉牡，有捄其角。以似以續，續古之人。"
    ]
  },
  {
    "id": 292,
  ...
  },
  {
    ...
    "stanzas": [
      ...
      "彌月不遲，是生后稷。降之百福。黍稷重穋，稙稚菽麥。奄有下國，俾民稼穡。",
      "有稷有黍，有稻有秬。奄有下土，纘禹之緒。后稷之孫，實維大王。",
      "居岐之陽，實始剪商。至於文武，纘大王之緒，致天之屆，於牧之野。",
      "無二無虞，上帝臨女。敦商之旅，克鹹厥功。王曰叔父，建爾元子，俾侯於魯。",
      "大啟爾宇，為周室輔。乃命魯公，俾侯於東。錫之山川，土田附庸。",
      "周公之孫，莊公之子。龍旂承祀。六轡耳耳。春秋匪解，享祀不忒。",
      "皇皇后帝！皇祖后稷！享以騂犧，是饗是宜。降福既多，周公皇祖，亦其福女。",
      "秋而載嘗，夏而楅衡，白牡騂剛。犧尊將將，毛炰胾羹。籩豆大房，萬舞洋洋。",
      "孝孫有慶。俾爾熾而昌，俾爾壽而臧。保彼東方，魯邦是嘗。不虧不崩，不震不騰。",
      "三壽作朋，如岡如陵。公車千乘，朱英綠縢。二矛重弓。公徒三萬，貝冑朱綅。",
      "烝徒增增，戎狄是膺，荊舒是懲，則莫我敢承！俾爾昌而熾，俾爾壽而富。",
      "黃髮臺背，壽胥與試。俾爾昌而大，俾爾耆而艾。萬有千歲，眉壽無有害。",
      "泰山岩巖，魯邦所詹。奄有龜蒙，遂荒大東。至於海邦，淮夷來同。",
      "莫不率從，魯侯之功。保有鳧繹，遂荒徐宅。至於海邦，淮夷蠻貊。",
      "及彼南夷，莫不率從。莫敢不諾，魯侯是若。天錫公純嘏，眉壽保魯。",
      "居常與許，復周公之宇。魯侯燕喜，令妻壽母。宜大夫庶士，邦國是有。",
...
export const chapterOrder = ["國風", "小雅", "大雅", "周頌", "魯頌", "商頌"] as const;
